...
from Recipes.finetuning_schwedin_v1 import run as finetuning_schwedin_v1
from Recipes.finetuning_schwedin_v1 import run as finetuning_schwedin_v2
...
pipeline_dict = {
    ...
    #"schwedin_v1": finetuning_schwedin_v1,
    "schwedin_v2": finetuning_schwedin_v2,
    # integration test
